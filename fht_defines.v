...
`define MATLAB_FHT_DONE_RAM		"../../fht/matlab/ram.txt" // math model FHT out RAM for compare
`define MATLAB_CONV_DONE_RAM	"../../fht_conv/matlab/reg_conv_ram.txt" // math model CONV by DHT out RAM for compare
